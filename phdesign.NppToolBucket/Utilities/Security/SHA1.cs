    ...
    public class SHA1
    {
        ...
        public static string ComputeHash(Stream inputStream)
        {
            var hash = BitConverter.ToString(
                System.Security.Cryptography.SHA1.Create().ComputeHash(inputStream)).Replace("-", "");
        ...
        public static string ComputeHash(string input)
        {
            ...
            return BitConverter.ToString(System.Security.Cryptography.SHA1.Create().ComputeHash(bytes)).Replace("-", "");
        } 
    }
}